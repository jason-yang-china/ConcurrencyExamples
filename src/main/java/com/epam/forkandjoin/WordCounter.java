...
public class WordCounter {
    ...
    public static void main(String[] args) throws IOException {
        ...
        Folder folder = Folder.fromDirectory(new File("D:\\Jason_Yang\\book\\java\\"));
        ...
        for (int i = 0; i < repeatCount; i++) {
            ...
            counts = wordCounter.countOccurrencesOnSingleThread(folder, "concurrrent");
        ...
        for (int i = 0; i < repeatCount; i++) {
            startTime = System.currentTimeMillis();
            counts = wordCounter.countOccurrencesInParallel(folder, "concurrrent");
            stopTime = System.currentTimeMillis();
